...
/**
 * Provides a 'MainCalendarSpudBlock' block.
 *
 * @Block(
 *  id = "main_calendar_spud_block",
 *  admin_label = @Translation("Main Calendar Spud"),
 * )
 */
class MainCalendarSpudBlock extends BlockBase {
